...
#define  MAINPNL_CHECKBOX                 15      /* control type: radioButton, callback function: CHECK1 */
#define  MAINPNL_CHECKBOX_2               16      /* control type: radioButton, callback function: (none) */
...
int  CVICALLBACK CHECK1(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
